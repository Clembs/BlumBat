...
public class VueModifierTravaux extends JFrame {
    ...
    public VueModifierTravaux(BienImmobilier bien, PanelTravaux panelTravaux) {
        this.bien = bien;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                VueModifierTravaux frame = new VueModifierTravaux(bien, panelTravaux);
